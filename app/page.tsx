  ...
  return (
    <article className="animate-fade-in border-glass-border bg-bg shadow-1 lg:shadow-5 z-1 rounded-[1.25rem] border p-4 pb-12 sm:mx-auto sm:w-130 sm:p-8 sm:pb-20 md:w-175 lg:w-237.5 xl:min-h-full xl:w-auto">
      ...
      <section className="mb-12">
          ...
          {TESTIMONIALS.map((testimonial, idx) => (
            ...
            >
              ...
              <div className="mb-2">
                ...
                <div className="text-yellow text-xs font-semibold">
                  {testimonial.date}
                </div>
              </div>
        ...
        {/* Generic Modal (Simple state base display) */}
        {activeTestimonial !== null && (
          <div
            className="animate-fade-in fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/80 p-4 backdrop-blur-sm"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div
              className="border-glass-border bg-bg relative w-full max-w-lg rounded-2xl border p-6 md:p-8"
              role="document"
            ...
            >
              ...
              <div className="mb-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-yellow text-sm font-semibold">
      ...
      <section className="mb-4">
        ...
        <div className="border-glass-border rounded-2xl border bg-white/5 p-8">
          <ul className="flex snap-x snap-mandatory gap-8 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {/* Clients are rendered with text instead of missing images to avoid crashing */}
            {CLIENTS.map((client) => (
              <li
                key={client.logo}
                className="flex min-w-[50%] shrink-0 snap-center items-center justify-center opacity-50 grayscale transition-all duration-300 hover:opacity-100 hover:grayscale-0 sm:min-w-[33.33%] md:min-w-[25%]"
              >
