...
export const metadata: Metadata = {
  title: "Blog",
  description:
    "Articles and insights on web development, React, Next.js, and software engineering by Omar Akhji.",
  openGraph: {
    title: "Blog | Omar Akhji",
    description:
      "Articles and insights on web development, React, Next.js, and software engineering.",
  },
};
