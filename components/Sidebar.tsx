...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      className={`border-glass-border bg-bg shadow-1 lg:shadow-5 rounded-card z-1 mb-4 overflow-hidden border p-4 transition-all duration-500 ease-in-out sm:mx-auto sm:mb-8 sm:w-130 sm:p-8 md:w-175 lg:w-237.5 xl:sticky xl:top-15 xl:mb-0 xl:h-full xl:max-h-max xl:w-auto xl:pt-15 ${
    ...
    >
      ...
      <header className="relative flex items-center justify-start gap-4 sm:gap-6 xl:flex-col">
        {/* Avatar */}
        <div className="border-glass-border shadow-2 from-yellow to-orange text-bg flex size-20 shrink-0 items-center justify-center rounded-full border bg-white/5 bg-linear-to-br text-[1.75rem] font-bold transition-transform hover:scale-105 sm:size-30 sm:text-[2.75rem] xl:mx-auto xl:size-37.5 xl:text-[3.5rem]">
          {initials}
        </div>
...
const ContactItem = ({
  ...
  <li className="flex min-w-full items-center gap-4">
    <div className="border-orange bg-card text-orange shadow-1 hover:shadow-3 flex size-7.5 shrink-0 items-center justify-center rounded-full border-2 transition-all hover:-translate-y-1 sm:size-12 sm:text-lg">
      {icon}
    </div>
